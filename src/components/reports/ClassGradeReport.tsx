...
export default function ClassGradeReport() {
  ...
  const handleExportExcel = () => {
    ...
    XLSX.utils.book_append_sheet(workbook, worksheet, t("classGradeReport.gradeList"));
  ...
  const handleExportWord = () => {
    ...
    const html = `
      ...
      <h2>${t("classGradeReport.title")}</h2>
            ...
            <div className="flex justify-between items-center">
              ...
              <div className="relative" onMouseLeave={() => setIsExportOpen(false)}>
                ...
                >
                  ...
                  {t("classGradeReport.exportReport")} <ChevronDown className="w-3 h-3 ml-1" />
                </button>
